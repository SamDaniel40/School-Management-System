...
<script>
    ...
    jQuery('#teacher-registration').on('submit', function(e) {
        ...
        if (true) {
            ...
            jQuery.ajax({
                type: "post",
                url: "http://localhost/School%20Management%20System/admin/ajax.php",
                data: formdata,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    ...
                    // location.href = 'http://localhost/School%20Management%20System/admin/user-account.php?user=teacher';
                },
                complete: function() {
                    // jQuery('#loader').hide();
                }
