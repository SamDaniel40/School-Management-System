      ...
      jQuery.ajax({
        ...
        success: function(response) {
          ...
          // if (response.success == true) {
            location.href = 'http://localhost/School%20Management%20System/Admin/user-account.php?user=student';
          // }
        },
        complete: function() {
        //   jQuery('#loader').hide();
...
<div class="modal fade" id="user-import-modal" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="http://localhost/School%20Management%20System/actions/student-registration.php" method="post" enctype="multipart/form-data">
