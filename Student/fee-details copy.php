            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo $action?>" method="post" name="payuForm">
                        <input type="hidden" name="surl" value="http://localhost:8888/School%20Management%20System/actions/success.php" size="64" />
        
		                <input type="hidden" name="furl" value="http://localhost:8888/School%20Management%20System/actions/failure.php" size="64" />
