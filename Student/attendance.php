                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <?php
                            ...
                            $current_year = date('Y');
                            $sql = "SELECT * FROM tbl_Attendance WHERE AttendanceMonth = ? AND year(CurrSession) = ?";

                            $query = sqlsrv_query($db_conn, $sql,array($current_month,$current_year));

                            $row = sqlsrv_fetch_object($query);

                            foreach(unserialize($row->AttendanceValue) as $date => $value){ ?>
                            <tr>
                                 <td><?php echo $date;?></td>
